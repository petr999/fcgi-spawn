...
# simulated packages
foreach (
    qw?Apache2/Response Apache2/RequestRec Apache2/RequestUtil
    Apache2/RequestIO APR/Pool APR/Table Apache2/SizeLimit
    ModPerl/RegistryLoader ModPerl/Registry Apache2/Const ModPerl ModPerl/Util
    Apache/Cookie Apache2/Cookie APR/Request APR/Request/Apache2
    Apache2/Request ModPerl/Const APR/Date Apache2/Upload Apache
    Apache/Constants Apache/Request Apache/Log Apache/Table mod_perl
